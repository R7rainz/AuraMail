...
function AuthContent() {
  ...
  if (user) {
    // If user is already authenticated, show a disabled sign-in button and redirect info
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-slate-950 to-black p-4">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8 space-y-6">
            <Button
              disabled
              className="w-full bg-white text-black font-semibold py-6 text-lg opacity-50 cursor-not-allowed"
            >
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8 space-y-6">
          <Button
            ...
            className={`w-full bg-white text-black hover:bg-gray-100 font-semibold py-6 text-lg${user ? " opacity-50 cursor-not-allowed" : ""}`}
          >
            {authLoading ? (
